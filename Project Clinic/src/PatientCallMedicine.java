 ...
 * @author Acer
 */
public class PatientCallMedicine extends javax.swing.JFrame {

    /**
     * Creates new form HomePatient
     */
    public PatientCallMedicine() {
        initComponents();
        Patient.initialize();
    }
    ...
    private void btSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSubmitActionPerformed
        ...
        try {
            ...
            boolean status = true;
            if(status) {
                DetailMedicine dtmdc = new DetailMedicine(patient);
                dtmdc.setVisible(true);
                this.dispose();
            } else {
