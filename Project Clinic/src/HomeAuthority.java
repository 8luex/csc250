 ...
 * @author Acer
 */
public class HomeAuthority extends javax.swing.JFrame {

    /**
     * Creates new form HomePatient
     */
    public HomeAuthority() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("หน้าหลักของเจ้าหน้าที่");

        jLabel1.setFont(new java.awt.Font("supermarket", 0, 18)); // NOI18N
        jLabel1.setText("หน้าหลักของเจ้าหน้าที่");

        jButton1.setFont(new java.awt.Font("Leelawadee", 0, 12)); // NOI18N
        jButton1.setText("ลงข้อมูลการซักถามอาการผู้ป่วย");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        AskPatientSymptoms aptst = new AskPatientSymptoms();
        aptst.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        MakeAnAppointment maapm = new MakeAnAppointment();
        maapm.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        AuthorityCallPaymentSlip acpmsl = new AuthorityCallPaymentSlip();
        acpmsl.setVisible(true);
        this.dispose();
