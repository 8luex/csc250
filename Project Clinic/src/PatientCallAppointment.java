 ...
 * @author Acer
 */
public class PatientCallAppointment extends javax.swing.JFrame {

    /**
     * Creates new form HomePatient
     */
    public PatientCallAppointment() {
        initComponents();
        Patient.initialize();
    }
    ...
    private void initComponents() {
        ...
        setTitle("ผู้ป่วยเรียกดูใบนัด");

        jLabel1.setFont(new java.awt.Font("supermarket", 0, 18)); // NOI18N
        jLabel1.setText("สอบถามใบนัดหมอ");
    ...
    private void btSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSubmitActionPerformed
        ...
        try {
                patient = Patient.FindPatient(jTextField1.getText());
        } catch (Exception e) {
            JLabel label = new JLabel("ไม่พบรหัสผู้ป่วยนี้ในระบบ");
            ...
            boolean status = true;
            if(status) {
                DetailAppointment dtapm = new DetailAppointment(patient);
                dtapm.setVisible(true);
                this.dispose();
            } else {
