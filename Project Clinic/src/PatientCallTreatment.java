 ...
 * @author Acer
 */
public class PatientCallTreatment extends javax.swing.JFrame {

    /**
     * Creates new form HomePatient
     */
    public PatientCallTreatment() {
        initComponents();
        Patient.initialize();
    }
    ...
    private void btSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSubmitActionPerformed
        ...
        try {
            ...
            boolean status = true;
            if(status) {
                DetailTreatment dttm = new DetailTreatment(patient);
                dttm.setVisible(true);
                this.dispose();
            } else {
