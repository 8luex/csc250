 ...
 * @author Acer
 */
public class DispenseMedicine extends javax.swing.JFrame {
    ...
    private void btSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSubmitActionPerformed
        ...
        try {
            ...
            boolean status = true;
            if(status) {
                DispenseMedicineInputId g = new DispenseMedicineInputId();
                g.setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Fail - Try again", "ไม่พบแพทย์รหัสนี้", JOptionPane.WARNING_MESSAGE);
            }
