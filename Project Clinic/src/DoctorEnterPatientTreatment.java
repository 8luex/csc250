 ...
 * @author Acer
 */
public class DoctorEnterPatientTreatment extends javax.swing.JFrame {

    /**
     * Creates new form HomePatient
     */
    public DoctorEnterPatientTreatment() {
        initComponents();
        try {
            Doctor.initialize();
        } catch (Exception ex) {
    ...
    private void btSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSubmitActionPerformed
        ...
        try {
            ...
            JLabel label = new JLabel("ไม่พบรหัสแพทย์นี้ในระบบ");
            ...
            boolean status = true;
            if(status) {
                DoctorEnterTreatmentId s = new DoctorEnterTreatmentId();
                s.setVisible(true);
                this.dispose();
            } else {
